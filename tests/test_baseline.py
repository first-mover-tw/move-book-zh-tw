...
_KNOWN_EMPHASIS_GAPS = {
    ...
    "book/programmability/capability.md": 3,
    "book/programmability/epoch-and-time.md": 1,
    "book/programmability/package-upgrades.md": 16,
    "book/programmability/publisher.md": 2,
    "book/programmability/randomness.md": 1,
    "book/storage/internal-constraint.md": 1,
    "book/storage/storage-functions.md": 5,
    "reference/abilities.md": 2,
    "reference/abort-and-assert/clever-errors.md": 1,
    "reference/control-flow/pattern-matching.md": 8,
